// -------------------------------------------------- //
// Scripts/Renderers/PrimitiveRenderer.cs
// -------------------------------------------------- //
...
public class PrimitiveRenderer
{
    ...
    public PrimitiveRenderer(BiomeManager biomeManager)
    {
    ...
    public void RenderDoorsOptimized(LevelModel layout, Transform parent)
    {
        ...
        else RenderDoorTopsAsPrimitives(layout, parent);
    }
    ...
    private void RenderDoorTopsAsPrimitives(LevelModel layout, Transform parent)
    {
        foreach (var doorPos in layout.AllDoorTiles)
        {
            ...
            Material material = new(Shader.Find("Standard")) { color = Color.gray };
    ...
    private Quaternion GetDoorRotation(LevelModel layout, Vector2Int doorPos)
    {
        ...
        Vector2Int[] directions = new Vector2Int[] { new(0, 1), new(0, -1), new(1, 0), new(-1, 0) };
    ...
    {
        Vector2Int[] checkDirections = new Vector2Int[] { new(0, 1), new(0, -1), new(1, 0), new(-1, 0) };
    ...
    private void RenderFloorsAsPrimitives(LevelModel layout, Transform parent)
    {
        ...
        foreach (var floorPos in layout.AllFloorTiles)
        {
            ...
            Material material = new(Shader.Find("Standard")) { color = Color.white };
            renderer.sharedMaterial = material;
