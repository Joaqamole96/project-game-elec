...
public class SpecialRoomRenderer
{
    ...
    private GameObject GetSpecialRoomPrefab(RoomType roomType)
    {
        ...
        {
            RoomType.Entrance => _biomeManager.GetPrefab(_currentBiome.EntrancePrefabPath),
            RoomType.Exit => _biomeManager.GetPrefab(_currentBiome.ExitPrefabPath),
            RoomType.Shop => _biomeManager.GetPrefab(_currentBiome.ShopPrefabPath),
            RoomType.Treasure => _biomeManager.GetPrefab(_currentBiome.TreasurePrefabPath),
            RoomType.Boss => _biomeManager.GetPrefab(_currentBiome.BossPrefabPath),
            _ => null
        };
    }
